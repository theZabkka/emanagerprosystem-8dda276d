...
const taskDefaults = { verification_start_time: null as string | null, not_understood: false, not_understood_at: null as string | null, correction_severity: null as string | null, client_review_accepted_by: null as string | null };
